...
public class WeigtedQuickUnionWithPathCompressionUF implements UnionFind {
    private int[] parent;
    private int[] rank; //记录各颗树的高度
    private int count; //component counts

    public WeigtedQuickUnionWithPathCompressionUF(int n){
        count = n;
        parent = new int[n];
        for(int i=0; i<n; i++) {
            parent[i] = i;
    ...
    public  static void main(String[] args) {
        int N = 100000;
        UnionFind uf = new WeigtedQuickUnionWithPathCompressionUF(N);
