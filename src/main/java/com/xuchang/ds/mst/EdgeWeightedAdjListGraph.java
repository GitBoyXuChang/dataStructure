...
public class EdgeWeightedAdjListGraph implements EdgeWeightedGraph {
	 ...
	 *             if {@code V < 0}
	 */
	public EdgeWeightedAdjListGraph(int V) {
		if (V < 0) {
	 ...
	 */
	public EdgeWeightedAdjListGraph(EdgeWeightedAdjListGraph G) {
		this(G.V());
		this.E = G.E();
		for (int v = 0; v < G.V(); v++) {
